        ...
        <div className="w-full flex flex-col justify-start gap-y-2">
          ...
          <div className="w-full flex items-center relative mt-2">
            ...
            <div className="flex ml-4 gap-x-[1px] overflow-hidden rounded-md items-center h-fit">
              {qtip?.quality && (
                <div className="bg-[#3324f2] px-[7px] w-fit flex justify-center items-center py-[1px] text-black">
              ...
              {qtip?.type && (
                <div className="absolute right-0 top-0 justify-center items-center rounded-sm bg-[#3324f2] px-[6px] text-black">
              ...
              <div className="leading-4 flex flex-wrap text-wrap">
                ...
                {qtip.genres.map((genre, index) => (
                  <Link
                    to={`/genre/${genre}`}
                    key={index}
                    className="text-[13px] hover:text-[#3324f2]"
                  >
          ...
          <Link to={qtip.watchLink} className='w-[80%] flex mt-4 justify-center items-center gap-x-2 bg-[#3324f2] py-[9px] rounded-3xl'>
            <FontAwesomeIcon
              icon={faPlay}
